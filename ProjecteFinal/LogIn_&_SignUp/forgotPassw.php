                ...
                if($info->email == $noPassw){
                    ...
                    if (mail($para, $asunto, $descripcion, $headers, $de))
                    {
                        ...
                        <div style='width: 100%; height: 100%; display: flex; flex-wrap: wrap; justify-content: center; align-content: center;'>
                            <div style='display: flex; color: black; align-content: center; justify-content: center; flex-wrap: wrap; background-color: green; width: 50vw; height: 50vh; font-family: monospace; text-align: center; font-size: large;'>
