    ...
    if($existEmail !== NULL){//comprobem que la query s'ha executat
        ...
        if($userEmail == $infoEmail->email){
            ...
            if(isset($_POST["recoverPassword"])){
                ...
                $hash_recoverPassword = password_hash($recoverPassword, PASSWORD_DEFAULT, [15]);

                //sentencia SQL per actualitzar la contrasenya de l'usuari
                $sqlNewPassw = "UPDATE users SET `password`='$hash_recoverPassword' WHERE email = '$userEmail'";
...
<head>
    ...
    <link rel="stylesheet" href="css/recoverPassw.css">
...
<body class=" bg-dark min-vh-100">
    ...
    <script src="js/recoverPassw.js"></script>
</body>
</html>