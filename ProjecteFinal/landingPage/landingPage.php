...
<div class='modal fade' id='formEdit' tabindex='-1' aria-labelledby='formEditlabel' aria-hidden='true'>
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editProdForm" name="editProdForm" onsubmit="editProdFood(); return false">
                ...
                <div id='badNote'>
                    <div>
                        ...
                        <div name='hide'>
                            ...
                            <div class='d-flex'>
                                <b class='infoProd'>- Shooping Date:</b>
                            ...
                            ?><?php
                                ...
                                <div class='d-flex' onclick='modalID($sqlgetProductsInfo->id)'>
                                    <b class='infoProd'>- Expiration Date:</b>
                                    <p id='caducitat_$sqlgetProductsInfo->id' class='badge bg-dark text-wrap fs-5 text-light'>$sqlgetProductsInfo->expirationDate</p>
                                </div>";
                            ?><?php
                            $output .= "
                            <div class='d-flex'>
                                <b class='infoProd'>- Open?:</b>
                                <p id='obert_$sqlgetProductsInfo->id' class='badge bg-light text-wrap fs-5 text-dark' data_value='$sqlgetProductsInfo->openOrNot'>$openOrNot</p>
                            </div>
                            <div class='d-flex'>
                    ...
                    <nav class='d-flex flex-row justify-content-around' >
                        <div onclick='editID($sqlgetProductsInfo->id)';>
                            <button id='editProduct' type='submit' class='btn btn-primary px-2 border' onclick='showEditProduct()'>Edit</button>
                        </div>
                        <form id='formID_$sqlgetProductsInfo->id' onsubmit='getProdInfo($sqlgetProductsInfo->id); return false'>
                            <input id='nameProdList_$sqlgetProductsInfo->id' name='nameProdList' type='hidden' value='$sqlgetProductsInfo->productName'>
                            <input id='typeProdList_$sqlgetProductsInfo->id' name='typeProdList' type='hidden' value='$sqlgetProductsInfo->type'>
                            <input id='placeList_$sqlgetProductsInfo->id' name='placeList' type='hidden' value='$sqlPlaceInfo->placeName'>
                            <input id='calList_$sqlgetProductsInfo->id' name='calList' type='hidden' value='$sqlgetProductsInfo->calories'>
                            <input id='llistaCompra' class='btn btn-secondary px-2 border' type='submit' value='Shopping List'>
                        </form>
                        <form id='deleteID_$sqlgetProductsInfo->id' onsubmit='deleteProd($sqlgetProductsInfo->id); return false'>
                ...
                <div id='goodNote'>
                    <div>
                        ...
                        <div name='hide'>
                            ...
                            <div class='d-flex'>
                                <b class='infoProd'>- Shopping Date:</b>
                                <p id='compra_$sqlgetProductsInfo->id' class='badge bg-light text-wrap fs-5 text-dark'>$sqlgetProductsInfo->shoppingDate</p>
                            </div>
                            ";
                            ?><?php
                    ...
                    <nav class='d-flex flex-row justify-content-around' >
                        ...
                        <form id='formID_$sqlgetProductsInfo->id' onsubmit='getProdInfo($sqlgetProductsInfo->id); return false'>
                            ...
                            <input id='placeList_$sqlgetProductsInfo->id' name='placeList' type='hidden' value='$sqlPlaceInfo->placeName'>
                            <input id='calList_$sqlgetProductsInfo->id' name='calList' type='hidden' value='$sqlgetProductsInfo->calories'>
                            <input id='llistaCompra' class='btn btn-outline-secondary px-2' type='submit' value='Shopping List'>
                        </form>
                        <form id='deleteID_$sqlgetProductsInfo->id' onsubmit='deleteProd($sqlgetProductsInfo->id); return false'>
                            <input id='deleteProduct' name='deleteProduct' type='hidden' value='$sqlgetProductsInfo->id'>
                            <input type='submit' class='btn btn-danger px-2 border' type='button' value='Delete'>
