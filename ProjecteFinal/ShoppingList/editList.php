...
if( $_POST ){
    ...
    if(isset($_SESSION['idUser']) && isset($_SESSION['idGroup']) && isset($_SESSION['email']) && isset($_SESSION['username']) && isset($_SESSION['password']) && isset($_SESSION['groupName'])) {
        ...
        if(isset($_POST['idEditList']) && isset($_POST['nameListEdit']) && isset($_POST['typeListEdit']) && isset($_POST['placeListEdit']) && isset($_POST['calListEdit'])){

            $idEditList = $_POST['idEditList'];
            $nameListEdit = $_POST['nameListEdit'];
            $typeListEdit = $_POST['typeListEdit'];
            $placeListEdit = $_POST['placeListEdit'];
            $calListEdit = $_POST['calListEdit'];

            //sentencia SQL per obtenir l'id pels Place
            $sqlGetPlaceID = "SELECT id FROM place WHERE placeName = '$placeListEdit'";
            //query de l'SQL
            ...
            if($dataGetPlaceID !== NULL){
                ...
                productName = '$nameListEdit',
                `type` = '$typeListEdit',
                calories = '$calListEdit',
